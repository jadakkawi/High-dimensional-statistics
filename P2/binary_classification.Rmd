---
title: "Binary Classification for e-nose air-quality data"
...
If we analyse a bit the full raw model
```{r}
...
```
Obviously colinearity is an ussue here
lets check vif and apply PCA
